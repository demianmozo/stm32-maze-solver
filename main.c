...
int main(void)
{
  ...
  // Iniciar con interrupcion habilitada
  IntEnable=1;
  ...
  // ---------------------------Inicializacion temporizador 14------------------------------*/
  //
  HAL_TIM_Base_Start_IT(&htim14);
  //
  // ---------------------------FIN Inicializacion temporizador 14------------------------------*/
...
//
// ----------------interrupcion correccion----------------*/
//
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
	if (htim->Instance == TIM14) {
		if (IntEnable == 1) {									//chequeo que esté habilitada la interrupción
			controlar_linea_recta();
		}
	}
}
// -------------- FIN interrupcion correccion--------------*/
//
//
